...
export VIBROSIM_REPOS="angled_friction_model closure_measurements crackclosuresim2 crackheat_surrogate2 tortuosity_tracing vibro_estparam VibroSim_COMSOL VibroSim_Simulator VibroSim_WelderModel crack_heatflow limatix heatsim2"
...
echo "It might be nice to also generate the .mtlbx version of VibroSim_COMSOL and add that to the .ZIP file /usr/local/src/VibroSim-$VERSION"
